...
import TopicQuestionPage from './pages/admin/TopicQuestionPage';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/admin-course/:courseId/lessons/:lessonId/topics/:topicId/questions" element={<RequireAuth role="ADMIN"><TopicQuestionPage /></RequireAuth>} />
